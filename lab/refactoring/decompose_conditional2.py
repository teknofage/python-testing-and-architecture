...
def test_cholesterol(total_cholesterol, ldl, triglyceride):
    good_cholesterol = total_cholesterol < 200 and ldl < 100 and triglyceride < 150
    high_cholesterol = 200 < total_cholesterol > 240 or ldl > 160 or triglyceride >= 200
    borderline_cholesterol = 200 <= total_cholesterol <= 240 or 130 <= ldl <= 160 or 150 <= triglyceride < 200
    if good_cholesterol:   # good level
...
test_cholesterol(total_cholesterol, ldl, triglyceride)